...
const translations = {
  id: {
    ...
    router_1300_desc: "Router dual-band entry-level untuk kebutuhan internet rumah standar.",
    router_1300_sig: "Signature 100 sampai 200 Mbps",
    router_6000_desc: "Router premium berperforma tinggi untuk jaringan padat dan kebutuhan cepat.",
  ...
  en: {
    ...
    router_1300_desc: "Entry-level dual-band router for standard home internet needs.",
    router_1300_sig: "Signature 100 to 200 Mbps",
    router_6000_desc: "High-performance premium router for dense networks and fast needs.",
...
function initMobilePackageCarousel() {
  const slider = document.querySelector(".package-grid");
  if (!slider) return;
  ...
  const start = () => {
    ...
    const cards = Array.from(slider.querySelectorAll(".package-card"));
